    ...
    >
      ...
      >
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <h2 style={{ fontWeight: 700, fontSize: 28, marginBottom: 8 }}>Create Account</h2>
          <div style={{ color: "#888", fontSize: 15, marginBottom: 24 }}>Please enter your details</div>
          <form onSubmit={e => { e.preventDefault(); register(); }}>
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "block", fontWeight: 500, fontSize: 15, marginBottom: 6 }}>Full Name <span style={{ color: "#dc3545" }}>*</span></label>
              <input
                type="text"
                value={name}
            ...
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "block", fontWeight: 500, fontSize: 15, marginBottom: 6 }}>OTP <span style={{ color: "#dc3545" }}>*</span></label>
              <input
                type="text"
                value={otp}
            ...
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "block", fontWeight: 500, fontSize: 15, marginBottom: 6 }}>Role <span style={{ color: "#dc3545" }}>*</span></label>
              <select
                value={role}
